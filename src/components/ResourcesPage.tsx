        ...
        <div className="bg-marble rounded-3xl shadow-2xl border-2 border-burgundy p-8 font-roman">
          ...
          <div className="space-y-4">
               ...
               <p className="text-sm text-stone-600 mb-3">
                 Dr. Ray Peat has a Ph.D. in Biology and specializes in physiology and aging research. His work focuses on nutrition, hormones, and health conditions including infertility, epilepsy, dementia, and diabetes.
               </p>
               <p className="text-sm text-stone-600 mb-3">
                 Peat emphasizes environmental influences on health, believing degenerative processes stem from environmental defects. His research explores therapeutic uses of progesterone, thyroid hormone, and coconut oil.
               </p>
               <a 
